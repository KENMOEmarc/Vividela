...
import com.template.auth.model.dto.*;
import com.template.auth.model.dto.CustomerStatsDto;
...
public class CustomerOrderController {
    ...
    public ResponseEntity<ApiResponse<UserDto>> getCustomerById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Client récupéré", UserMapper.toDto(user)));
    }
    ...
    public ResponseEntity<ApiResponse<UserDto>> createCustomer(
        ...
        User created = userService.createCustomer(request, currentUserId);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Client créé avec succès", UserMapper.toDto(created)));
    }
    ...
    public ResponseEntity<ApiResponse<UserDto>> updateCustomer(
        ...
        User updated = userService.updateCustomerInfo(id, request);
        return ResponseEntity.ok(ApiResponse.success("Client mis à jour avec succès", UserMapper.toDto(updated)));
    }

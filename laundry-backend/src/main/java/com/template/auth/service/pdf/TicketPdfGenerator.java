...
public final class TicketPdfGenerator {
     ...
     *             — voir revue de code "Identité boutique en dur dans le code".
     */
    public static byte[] generate(Order order, List<Article> articles, Ticket ticket, ShopProperties shop) {
        try {
            ...
            Paragraph title = new Paragraph(shop.getName(), titleFont);
            ...
            Paragraph footer = new Paragraph(shop.getName(), smallFont);

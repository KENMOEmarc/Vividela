...
import com.template.auth.exception.InvalidCredentialsException;
...
import com.template.auth.security.JwtTokenProvider;
 ...
 * │  TokenBlacklistService → blacklist Redis (logout)      │
 * └─────────────────────────────────────────────────────────┘
 */
@Slf4j
@Service
...
public class AuthServiceImpl implements AuthService {
    ...
    /**
     * Déconnexion : révoque le token dans Redis.
     * <p>

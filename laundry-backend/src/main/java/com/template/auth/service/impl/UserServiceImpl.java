...
import com.template.auth.exception.PasswordMismatchException;
import com.template.auth.exception.UserAlreadyExistsException;
...
public class UserServiceImpl implements UserService {
    ...
    private final com.template.auth.repository.OrderRepository orderRepository;
    ...
    @Override
    public User create(UserFormRequest request, Long currentUserId) {
        ...
        if (roleRank(role) > roleRank(creator != null ? RoleType.valueOf(creator.getRole().toUpperCase()) : null)) {
    ...
    @Override
    public User update(Long id, UserFormRequest request, Long currentUserId) {
        ...
        RoleType callerRole = currentUser != null ? RoleType.valueOf(currentUser.getRole().toUpperCase()) : null;
        RoleType targetCurrentRole = RoleType.valueOf(user.getRole().toUpperCase());
    ...
    public void delete(Long id, Long currentUserId) {
        ...
        if (RoleType.ADMIN.toString().equalsIgnoreCase(user.getRole())) {
    ...
    public List<User> findAllCustomer() {
        return findAll().stream()
                .filter(user ->
                        user.getRole()
                                .equalsIgnoreCase(RoleType.CUSTOMER.toString())
                )
                .toList();
    }
    ...
    @Override
    public User createCustomer(UserFormRequest request, Long currentUserId) {
    ...
    @Override
    public User updateCustomerInfo(Long id, UserFormRequest request) {

...
-- ============================================================
-- NOUVELLES COMMANDES (5 requêtes)
-- ============================================================

INSERT INTO orders (client_user_id, deposit_date, expected_delivery_date, status, payment_status, total_amount, discount_amount, loyalty_points_used, created_by) VALUES (5, '2026-06-25', '2026-06-28', 'IN_PROGRESS', 'PENDING', 8600, 0, 0, 2);
INSERT INTO orders (client_user_id, deposit_date, expected_delivery_date, status, payment_status, total_amount, discount_amount, loyalty_points_used, created_by) VALUES (6, '2026-06-26', '2026-06-29', 'RECEIVED', 'PENDING', 7300, 0, 0, 2);
INSERT INTO orders (client_user_id, deposit_date, expected_delivery_date, status, payment_status, total_amount, discount_amount, loyalty_points_used, created_by) VALUES (5, '2026-06-27', '2026-06-30', 'PENDING', 'PENDING', 12400, 500, 20, 2);
INSERT INTO orders (client_user_id, deposit_date, expected_delivery_date, status, payment_status, total_amount, discount_amount, loyalty_points_used, created_by) VALUES (6, '2026-06-28', '2026-07-01', 'READY', 'COMPLETED', 9800, 0, 0, 2);
INSERT INTO orders (client_user_id, deposit_date, expected_delivery_date, status, payment_status, total_amount, discount_amount, loyalty_points_used, created_by) VALUES (5, '2026-06-29', '2026-07-02', 'IN_PROGRESS', 'COMPLETED', 5400, 0, 0, 2);

-- ============================================================
-- ARTICLES DES COMMANDES (13 requêtes)
-- ============================================================

INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (3, 'SHIRT', 'L', 'COTTON', 'Bleu ciel', 'Chemise manches longues', 'IRONING');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (3, 'PANTS', 'L', 'COTTON', 'Noir', 'Jean Levis', 'WASHING');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (3, 'JACKET', 'XL', 'WOOL', 'Gris', 'Veste costume', 'QUALITY_CHECK');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (4, 'DRESS', 'M', 'SILK', 'Rouge', 'Robe de soirée', 'PENDING');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (4, 'SKIRT', 'S', 'COTTON', 'Jaune', 'Jupe Wax', 'PENDING');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (4, 'BLOUSE', 'M', 'POLYESTER', 'Blanc', 'Chemisier bureau', 'PENDING');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (5, 'SUIT', 'XL', 'WOOL', 'Noir', 'Costume mariage', 'PACKED');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (5, 'SHIRT', 'XL', 'COTTON', 'Blanc', 'Chemise cérémonie', 'PACKED');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (5, 'BELT', 'UNIQUE', 'LEATHER', 'Noir', 'Ceinture cuir', 'PACKED');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (6, 'COAT', 'XL', 'WOOL', 'Marron', 'Manteau hiver', 'COMPLETED');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (6, 'SCARF', 'UNIQUE', 'WOOL', 'Rouge', 'Echarpe laine', 'COMPLETED');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (7, 'JEANS', 'L', 'COTTON', 'Bleu', 'Jean Slim', 'WASHING');
INSERT INTO articles (order_id, clothing_type, size, fabric, color, distinction, status) VALUES (7, 'T_SHIRT', 'M', 'COTTON', 'Blanc', 'T-shirt Nike', 'PENDING');

-- ============================================================
-- SERVICES APPLIQUES AUX ARTICLES (17 requêtes)
-- ============================================================
...
-- ============================================================
-- TRAITEMENTS EFFECTUES PAR LES EMPLOYES (8 requêtes)
-- ============================================================

INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (5, 3, 'WASH', '2026-06-25 08:00:00', '2026-06-25 09:30:00', 'Lavage standard');
INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (5, 4, 'IRON', '2026-06-25 10:00:00', '2026-06-25 10:30:00', 'Repassage vapeur');
INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (6, 3, 'WASH', '2026-06-25 08:30:00', NULL, 'Cycle délicat');
INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (7, 4, 'DRY_CLEAN', '2026-06-25 09:00:00', NULL, 'Nettoyage à sec');
INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (8, 3, 'DRY_CLEAN', '2026-06-26 08:00:00', NULL, 'Soie');
INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (11, 4, 'DRY_CLEAN', '2026-06-27 09:00:00', '2026-06-27 11:30:00', 'Costume');
INSERT INTO treatments (article_id, employee_user_id, service, started_at, completed_at, notes) VALUES (14, 3, 'DRY_CLEAN', '2026-06-28 10:00:00', '2026-06-28 13:00:00', 'Manteau laine');

-- ============================================================
-- PAIEMENTS (5 requêtes)
-- ============================================================

INSERT INTO payments (order_id, payment_method, amount, payer_phone, transaction_reference, status, created_by) VALUES (3, 'MOBILE_PAYMENT', 8600, '237698765432', 'OM-260625-001', 'PENDING', 2);
INSERT INTO payments (order_id, payment_method, amount, payer_phone, transaction_reference, status, created_by) VALUES (4, 'CASH', 7300, NULL, NULL, 'PENDING', 2);
INSERT INTO payments (order_id, payment_method, amount, payer_phone, transaction_reference, status, created_by) VALUES (5, 'CHECK', 12400, NULL, 'CHQ-00125', 'PENDING', 2);
INSERT INTO payments (order_id, payment_method, amount, payer_phone, transaction_reference, status, created_by) VALUES (6, 'MOBILE_PAYMENT', 9800, '237670998877', 'MOMO-260628-001', 'COMPLETED', 2);
INSERT INTO payments (order_id, payment_method, amount, payer_phone, transaction_reference, status, created_by) VALUES (7, 'CASH', 5400, NULL, NULL, 'COMPLETED', 2);
